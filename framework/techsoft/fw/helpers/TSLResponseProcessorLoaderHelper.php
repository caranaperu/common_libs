...
class TSLResponseProcessorLoaderHelper {
     ...
     * 'json', 'xml','csv'
     *
     * Importante : Se asume que si se usan los procesadores default , en el include path default
     ...
     *
     * @param string|null $library_id Indica si usa un procesador especifico de libreria soportada
     ...
     *
     */
    public static function loadProcessor(?string $processor_name = NULL, ?string $format_type = NULL, ?string $library_id = NULL) : TSLIResponseProcessor {
