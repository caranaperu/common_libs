 ...
 *
 * Todos los modelos deberan tener al menos un id y una version de registro,valor
 * que se usara para ver si hay cambios previo a una actualizacion del mismo.
 *
 * Por Ejemplo :
 *
 * <pre>
...
class TSLDataModel implements TSLJsonAble {
    ...
    /**
     * identificador unico de la version del modelo en la persistencia,
     * un cambio en este valor representara que el registro representado por este modelo ha sido modificado.
     *
     * @var integer|string
     */
    protected $versionId;
     ...
     *
     * @param array|null $options arreglo con los pares que representan el Campo-Valor
     */
     ...
     * @param mixed  $value El valor a asignar al atributo
     *
     * @return void
     *
     */
     ...
     *
     * Importante no se usa el hint por problemas en la interpretacion del bool
     ...
     *
     * @return bool true si el id es secuencia o identity o false si no lo es
     */
     ...
     * del analisis del mismo , esto es ya que muchas persistencias de datos
     * en especial las bases de datos devuelven diferentes valores como :
     * f , F,T,Y etc para representar un booleano en la base de datos.
     *
     * @param mixed $value
     *
     * @return bool
