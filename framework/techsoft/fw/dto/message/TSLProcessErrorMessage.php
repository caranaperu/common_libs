...
class TSLProcessErrorMessage extends TSLBaseMessage {
     ...
     * 
     * @param Throwable|null $exception en caso el error provenga de una excepcion
     * 
     */
    public function __construct(int $errorCode, ?string $errorMessage=null, ?Throwable $exception=null) {
