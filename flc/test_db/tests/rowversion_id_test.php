...
class class_entity extends flcBaseModel {
    public function __construct() {
        ...
        $this->fields = ['id'=>null,'name'=> null,'value'=>null,$rowversion_field=>null];
        //$this->key_fields = ['name'];
        $this->id_field = 'id';
        $this->table_name = 'tb_rowid_id';
        $this->field_types = [$rowversion_field=>'rowversion','value'=> 'nostring','id'=>'nostring'];
    }
