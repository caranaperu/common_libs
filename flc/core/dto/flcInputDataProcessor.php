...
/**
 * Class that will be used as glue between the external source of data and the model/
 * model.
 *
...
abstract class flcInputDataProcessor {
    /**
     * The operation to do over the model ,
     * can be:
     *      add
     *      del
     *      fetch
    ...
    /**
     * Array of fields part of the model
     ...
     */
    public abstract function process_input_data(flcBaseModel $p_model);
     ...
     * and can be interpreted in the model class.
     * @return string
     */
