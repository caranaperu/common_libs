 ...
 * @version 1.1
 * @history   21-08-2021 , al fin se reparo el problema del autofocus en el campo correcto al entrar a un add.
 *            22-08-2021 , se agrego 2 propiedades askForSave y askMessage para permitir si se requiere que al usuario se
 *                          le consulte si desea realizar la operacion o no.
 * @since 1.00
...
isc.DynamicFormExt.addProperties({
    ...
    /**
     * @cfg {boolean} si se requiere que antes de grabar se consulte si desea grabar
     * poner esta variable en true..
     */
    askForSave: false,
    /**
     * @cfg {string} si askForSave es true , este sera el texto a usar para preguntar antes
     * de grabar.
     */
    askMessage: 'Desea Grabar el Registro ?',
    /**
